...
from models.twitter_connection import *
...
if last_data_date == get_date_str(-1):
    ...
    url = "https://www.quandl.com/api/v3/datatables/WIKI/PRICES.json?api_key={}&qopts.columns=ticker&date=2017-10-11".format(apiKey)
    t = requests.get(url)
